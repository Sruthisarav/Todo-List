...
function (_Component) {
  ...
  function Home(props) {
    ...
    addNewTodoList = function addNewTodoList(item) {
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('http://localhost:3001/api/v1/todo_lists', item).then(function (response) {
...
/******/ });
//# sourceMappingURL=server_rendering-5448492520a135cef439.js.map