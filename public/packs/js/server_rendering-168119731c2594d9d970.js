...
function (_Component) {
  ...
  function Table(_props) {
    ...
    _this.updateTodoList = function (todo_list) {
      var todo_listIndex = props.todo_lists.findIndex(function (x) {
        return x.id === todo_list.id;
      });
      var todo_lists = update(props.todo_lists, _defineProperty({}, todo_listIndex, {
        $set: todo_list
      }));
    ...
    value: function render() {
      ...
      var items = this.props.todo_lists.map(function (data) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ItemBox__WEBPACK_IMPORTED_MODULE_1__["default"], {
          ...
          editingTodoListId: props.editingTodoListId,
          id: data.id,
...
/******/ });
//# sourceMappingURL=server_rendering-168119731c2594d9d970.js.map